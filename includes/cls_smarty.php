...
class Smarty
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ($cache_id)
                    {
                        $cachename = $GLOBALS['skins'].'_'.basename($filename, strrchr($filename, '.')) . '_' . $cache_id;
    ...
    {
        $name = $this->compile_dir . '/' .$GLOBALS['skins'].'_'. basename($filename) . '.php';
        if ($this->_expires)
        {
