...
switch($_GET['a'])
{
	...
	case 'post':
			...
			{
				$db->query("INSERT INTO ".table('groupbuy')." SET catid='$catid',siteid='$siteid',shopid='$shopid',goodsid='$goodsid',goodsname='$goodsname',title='$title',img='$img',goodsprice='$goodsprice',groupprice='$groupprice',endtime='$endtime',minjoins='$minjoins',info='$info',content='$content'  ");
			}
			errback('团购保存成功');
	case 'del':
			$id=intval($_GET['id']);
