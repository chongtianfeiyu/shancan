...
}elseif($a=='db')
{
		...
		$db->query("update ".table('shopconfig')." set opentime='$opentime',starthour='$starthour',startminute='$startminute',endhour='$endhour',endminute='$endminute',showweek='$showweek',minprice='$minprice',email='$email',isemail='$isemail',sendprice='$sendprice',ordertype='$ordertype' WHERE shopid='$shopid'");
