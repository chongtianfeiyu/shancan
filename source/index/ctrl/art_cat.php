...
//seo选项
$smarty->assign("title",$catrs['cname']?$catrs['cname'].'-'.$web['webtitle']:$web['webtitle']);
$smarty->assign("keywords",$catrs['keyword']?$catrs['keyword'].','.$web['webkey']:$web['webkey']);
$smarty->assign("description",$catrs['des']?$catrs['des']:$web['webdes']);
//seo选项结束
if(!$catrs)
{
